...
var Consts = {
    debug: true,
    api_root: navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|IEMobile)/) ? 'http://10.0.2.2:3000/' : 'http://localhost:3000/',
    // api_root: Utils.isLocal ?   'http://localhost:3000/': 'http://treatsforlife-api.herokuapp.com/',//'http://tfl.bchmn.com/',//'http://treatsforlife-api.herokuapp.com/','http://10.0.2.2:3000/','http://localhost:3000/'
